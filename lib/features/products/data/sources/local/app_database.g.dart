    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ProductsEntity` (`id` INTEGER NOT NULL, `title` TEXT NOT NULL, `description` TEXT NOT NULL, `price` REAL NOT NULL, `category` TEXT NOT NULL, `image` TEXT NOT NULL, `rating` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$ProductsDao extends ProductsDao {
  ...
  @override
  Future<void> insertProduct(ProductsEntity productEntity) async {
    await _productsEntityInsertionAdapter.insert(
        productEntity, OnConflictStrategy.replace);
  }

  @override
  Future<void> deleteProduct(ProductsEntity productEntity) async {
    await _productsEntityDeletionAdapter.delete(productEntity);
  }
}
